...
public class CasinoRunner {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < entries; i++) {
            ...
            System.out.println("Please tell how much you are gambling with today: ");
...
//        System.out.println(casino.getSize());
//        for (Player gambler: players){
//            System.out.println(gambler.name);
//        }
        ...
        for (Player gambler: players){
            ...
            switch(gameChoice){
                case 1:
                    ...
                    break;
                case 2:
                    if (gameChoice == 2 && gamePlayers < bacca.getMaximumNoOfPlayers()) {
                        ...
                        System.out.println("\nSorry only seven players can play Baccarat.\n");
                    }
                    break;
                case 3:
                    if (gameChoice ==3  && gamePlayers < blackJack.getMaximumNoOfPlayers()) {
