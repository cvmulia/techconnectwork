...
const verdict = declareWeapon(); // The weapon is the Revolver
console.log(verdict);
```
...
const changeMurderer = function() {
  ...
  plotTwist(); // this function is still in another function
}
...
console.log(verdict); // Mrs. Peacock, Dining room, lead pipe
```
...
const verdict = declareMurderer();
console.log(verdict);  // The murderer is Mrs. Peacock
```
